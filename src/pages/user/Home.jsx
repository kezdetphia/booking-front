      ...
      <div className="flex flex-col justify-center items-center pt-10">
        ...
        <div className="w-[70%]">
          <p className="text-sm text-gray-500 text-center py-10 font-serif">
            ...
            shop blablabala Best shop blablabala Best shop blablabala Best shop
            blablabala Best shop blablabala Best shop blablabala Best shop
            blablabala Best shop blablabala Best shop blablabala
          </p>
        </div>
